...
export const metadata: Metadata = {
  title: "MetaMask SDK Quickstart - wagmi",
  description: "A quickstart application to demonstrate integrating the MetaMask SDK with a Next.js application using wagmi.",
};
